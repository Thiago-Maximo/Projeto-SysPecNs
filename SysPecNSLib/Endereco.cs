...
{//declaração das variaveis
    public class Endereco
    {
        ...
        public Endereco( int? clienteId, string? cep, string? logradrouro, string? numero, string? complemento, string? bairro, string? cidade, string? uf, string? tipoEndereco)
        {
            ClienteId = clienteId;
            Cep = cep;
            Logradouro = logradrouro;
